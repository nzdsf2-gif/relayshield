...
If you want the check before the argument, it is a Claude Code plugin:
...
The rest of this is why it exists.
...
[api.relayshield.net/developers](https://api.relayshield.net/developers?source=agent-bait-devto)*
