# Who Can Publish Into Your Dependencies, and Into Your Model Repos?

*The credential that lets someone push a new npm version and the credential that lets them push new weights are the same kind of thing, live in the same file, and leak in the same stealer log.*
...
[our dependency-risk API](https://api.relayshield.net/developers?source=rsscan-deps-hf), included flat
