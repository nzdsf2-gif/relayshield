...
def handle_taxii_discovery(params: dict, api_key_record: dict) -> dict:
    return {
        ...
        "body": json.dumps({
            ...
            "description": "RelayShield TAXII 2.1 server — 5,600,000+ IOCs from 90 criminal Telegram channels and 20 authoritative feeds",
...
TAXII_COLLECTION = {
    ...
    "description": "Malicious IPs, domains, URLs, and file hashes from 90 criminal Telegram channels and 20 authoritative threat feeds. 3,800+ malware families tracked.",
    "can_read":    True,
    "can_write":   False,
