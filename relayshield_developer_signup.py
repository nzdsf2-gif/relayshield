...
# THE QR, AND THE CONSTANT BESIDE IT IS THE WHOLE SAFETY MECHANISM.
#
# WHY A QR HERE AND NOWHERE ELSE. A QR only beats a link when the reader's
# device cannot tap it: print, a slide, or a DESKTOP browser where the phone
# that would open WhatsApp is a different object. This is the one surface of
# ours with a desktop-heavy audience. On the blog footer and inside the Mini App
# a phone cannot scan its own screen, so a link is strictly better and this is
# hidden below a phone-width breakpoint.
#
# WHY IT IS STATIC, AND WHY THAT IS DANGEROUS. The number is read from Secrets
# Manager at request time, but a QR has to be ENCODED, and encoding one here
# means carrying a QR implementation for a footer. So the image is generated
# once by tools/wa_qr.py and committed.
#
# THAT MAKES IT THE WORST KIND OF STALE ARTEFACT IF THE NUMBER CHANGES. A QR is
# unreadable by a human, so nobody would see it pointing at the old number, and
# wa.me answers a wrong number with HTTP 200 and an "invalid" page rather than
# an error. It would look live to every probe we own.
#
# SO IT FAILS CLOSED. WA_QR_NUMBER records the number this SVG encodes, and the
# QR renders only when that matches what the secret returns. On any divergence
# the page shows the tappable link alone, which is always correct because it is
# built from the secret. A QR that MIGHT be wrong is not shown at all.
WA_QR_NUMBER = "17407373961"
WA_QR_SVG = (
    "<svg role=\"img\" aria-label=\"WhatsApp QR code\" version=\"1.1\" viewBox=\"0 0 37 37\" xmlns=\"http://www.w3.org/2000/"
    "svg\"><path fill=\"currentColor\" d=\"M4,4H5V5H4zM5,4H6V5H5zM6,4H7V5H6zM7,4H8V5H7zM8,4H9V5H8zM9,4H10V5H9zM10,4H11V"
    "5H10zM12,4H13V5H12zM14,4H15V5H14zM16,4H17V5H16zM20,4H21V5H20zM21,4H22V5H21zM23,4H24V5H23zM26,4H27V5H26zM27,4H2"
    "8V5H27zM28,4H29V5H28zM29,4H30V5H29zM30,4H31V5H30zM31,4H32V5H31zM32,4H33V5H32zM4,5H5V6H4zM10,5H11V6H10zM12,5H13"
    "V6H12zM13,5H14V6H13zM16,5H17V6H16zM18,5H19V6H18zM20,5H21V6H20zM21,5H22V6H21zM26,5H27V6H26zM32,5H33V6H32zM4,6H5"
    "V7H4zM6,6H7V7H6zM7,6H8V7H7zM8,6H9V7H8zM10,6H11V7H10zM13,6H14V7H13zM17,6H18V7H17zM18,6H19V7H18zM19,6H20V7H19zM2"
    "2,6H23V7H22zM26,6H27V7H26zM28,6H29V7H28zM29,6H30V7H29zM30,6H31V7H30zM32,6H33V7H32zM4,7H5V8H4zM6,7H7V8H6zM7,7H8"
    "V8H7zM8,7H9V8H8zM10,7H11V8H10zM12,7H13V8H12zM13,7H14V8H13zM14,7H15V8H14zM16,7H17V8H16zM17,7H18V8H17zM19,7H20V8"
    "H19zM20,7H21V8H20zM21,7H22V8H21zM22,7H23V8H22zM24,7H25V8H24zM26,7H27V8H26zM28,7H29V8H28zM29,7H30V8H29zM30,7H31"
    "V8H30zM32,7H33V8H32zM4,8H5V9H4zM6,8H7V9H6zM7,8H8V9H7zM8,8H9V9H8zM10,8H11V9H10zM15,8H16V9H15zM17,8H18V9H17zM18,"
    "8H19V9H18zM19,8H20V9H19zM20,8H21V9H20zM21,8H22V9H21zM22,8H23V9H22zM23,8H24V9H23zM24,8H25V9H24zM26,8H27V9H26zM2"
    "8,8H29V9H28zM29,8H30V9H29zM30,8H31V9H30zM32,8H33V9H32zM4,9H5V10H4zM10,9H11V10H10zM14,9H15V10H14zM15,9H16V10H15"
    "zM17,9H18V10H17zM18,9H19V10H18zM21,9H22V10H21zM22,9H23V10H22zM23,9H24V10H23zM24,9H25V10H24zM26,9H27V10H26zM32,"
    "9H33V10H32zM4,10H5V11H4zM5,10H6V11H5zM6,10H7V11H6zM7,10H8V11H7zM8,10H9V11H8zM9,10H10V11H9zM10,10H11V11H10zM12,"
    "10H13V11H12zM14,10H15V11H14zM16,10H17V11H16zM18,10H19V11H18zM20,10H21V11H20zM22,10H23V11H22zM24,10H25V11H24zM2"
    "6,10H27V11H26zM27,10H28V11H27zM28,10H29V11H28zM29,10H30V11H29zM30,10H31V11H30zM31,10H32V11H31zM32,10H33V11H32z"
    "M12,11H13V12H12zM13,11H14V12H13zM19,11H20V12H19zM20,11H21V12H20zM21,11H22V12H21zM23,11H24V12H23zM4,12H5V13H4zM"
    "6,12H7V13H6zM7,12H8V13H7zM9,12H10V13H9zM10,12H11V13H10zM11,12H12V13H11zM18,12H19V13H18zM19,12H20V13H19zM21,12H"
    "22V13H21zM23,12H24V13H23zM24,12H25V13H24zM26,12H27V13H26zM29,12H30V13H29zM31,12H32V13H31zM32,12H33V13H32zM4,13"
    "H5V14H4zM6,13H7V14H6zM9,13H10V14H9zM11,13H12V14H11zM13,13H14V14H13zM15,13H16V14H15zM16,13H17V14H16zM19,13H20V1"
    "4H19zM20,13H21V14H20zM23,13H24V14H23zM25,13H26V14H25zM26,13H27V14H26zM27,13H28V14H27zM28,13H29V14H28zM32,13H33"
    "V14H32zM6,14H7V15H6zM7,14H8V15H7zM10,14H11V15H10zM14,14H15V15H14zM15,14H16V15H15zM16,14H17V15H16zM20,14H21V15H"
    "20zM21,14H22V15H21zM25,14H26V15H25zM30,14H31V15H30zM31,14H32V15H31zM5,15H6V16H5zM6,15H7V16H6zM7,15H8V16H7zM8,1"
    "5H9V16H8zM9,15H10V16H9zM11,15H12V16H11zM13,15H14V16H13zM14,15H15V16H14zM17,15H18V16H17zM19,15H20V16H19zM20,15H"
    "21V16H20zM22,15H23V16H22zM25,15H26V16H25zM26,15H27V16H26zM27,15H28V16H27zM28,15H29V16H28zM32,15H33V16H32zM4,16"
    "H5V17H4zM5,16H6V17H5zM7,16H8V17H7zM9,16H10V17H9zM10,16H11V17H10zM13,16H14V17H13zM14,16H15V17H14zM15,16H16V17H1"
    "5zM16,16H17V17H16zM17,16H18V17H17zM18,16H19V17H18zM19,16H20V17H19zM21,16H22V17H21zM22,16H23V17H22zM24,16H25V17"
    "H24zM25,16H26V17H25zM29,16H30V17H29zM30,16H31V17H30zM4,17H5V18H4zM5,17H6V18H5zM6,17H7V18H6zM8,17H9V18H8zM9,17H"
    "10V18H9zM11,17H12V18H11zM12,17H13V18H12zM13,17H14V18H13zM16,17H17V18H16zM18,17H19V18H18zM20,17H21V18H20zM22,17"
    "H23V18H22zM23,17H24V18H23zM24,17H25V18H24zM26,17H27V18H26zM30,17H31V18H30zM31,17H32V18H31zM32,17H33V18H32zM4,1"
    "8H5V19H4zM5,18H6V19H5zM7,18H8V19H7zM8,18H9V19H8zM10,18H11V19H10zM11,18H12V19H11zM12,18H13V19H12zM16,18H17V19H1"
    "6zM17,18H18V19H17zM18,18H19V19H18zM20,18H21V19H20zM21,18H22V19H21zM22,18H23V19H22zM23,18H24V19H23zM24,18H25V19"
    "H24zM25,18H26V19H25zM28,18H29V19H28zM30,18H31V19H30zM31,18H32V19H31zM32,18H33V19H32zM4,19H5V20H4zM5,19H6V20H5z"
    "M7,19H8V20H7zM8,19H9V20H8zM9,19H10V20H9zM11,19H12V20H11zM13,19H14V20H13zM14,19H15V20H14zM16,19H17V20H16zM18,19"
    "H19V20H18zM23,19H24V20H23zM24,19H25V20H24zM26,19H27V20H26zM27,19H28V20H27zM31,19H32V20H31zM5,20H6V21H5zM7,20H8"
    "V21H7zM8,20H9V21H8zM10,20H11V21H10zM11,20H12V21H11zM12,20H13V21H12zM13,20H14V21H13zM16,20H17V21H16zM17,20H18V2"
    "1H17zM20,20H21V21H20zM22,20H23V21H22zM27,20H28V21H27zM28,20H29V21H28zM29,20H30V21H29zM31,20H32V21H31zM5,21H6V2"
    "2H5zM8,21H9V22H8zM9,21H10V22H9zM14,21H15V22H14zM16,21H17V22H16zM17,21H18V22H17zM18,21H19V22H18zM22,21H23V22H22"
    "zM25,21H26V22H25zM29,21H30V22H29zM30,21H31V22H30zM31,21H32V22H31zM4,22H5V23H4zM10,22H11V23H10zM13,22H14V23H13z"
    "M17,22H18V23H17zM18,22H19V23H18zM19,22H20V23H19zM20,22H21V23H20zM25,22H26V23H25zM27,22H28V23H27zM28,22H29V23H2"
    "8zM30,22H31V23H30zM6,23H7V24H6zM7,23H8V24H7zM8,23H9V24H8zM12,23H13V24H12zM16,23H17V24H16zM18,23H19V24H18zM19,2"
    "3H20V24H19zM21,23H22V24H21zM24,23H25V24H24zM25,23H26V24H25zM27,23H28V24H27zM30,23H31V24H30zM5,24H6V25H5zM8,24H"
    "9V25H8zM9,24H10V25H9zM10,24H11V25H10zM11,24H12V25H11zM12,24H13V25H12zM15,24H16V25H15zM18,24H19V25H18zM21,24H22"
    "V25H21zM22,24H23V25H22zM23,24H24V25H23zM24,24H25V25H24zM25,24H26V25H25zM26,24H27V25H26zM27,24H28V25H27zM28,24H"
    "29V25H28zM29,24H30V25H29zM30,24H31V25H30zM12,25H13V26H12zM15,25H16V26H15zM18,25H19V26H18zM19,25H20V26H19zM20,2"
    "5H21V26H20zM22,25H23V26H22zM23,25H24V26H23zM24,25H25V26H24zM28,25H29V26H28zM29,25H30V26H29zM30,25H31V26H30zM31"
    ",25H32V26H31zM32,25H33V26H32zM4,26H5V27H4zM5,26H6V27H5zM6,26H7V27H6zM7,26H8V27H7zM8,26H9V27H8zM9,26H10V27H9zM1"
    "0,26H11V27H10zM12,26H13V27H12zM14,26H15V27H14zM16,26H17V27H16zM17,26H18V27H17zM18,26H19V27H18zM20,26H21V27H20z"
    "M21,26H22V27H21zM22,26H23V27H22zM23,26H24V27H23zM24,26H25V27H24zM26,26H27V27H26zM28,26H29V27H28zM29,26H30V27H2"
    "9zM31,26H32V27H31zM4,27H5V28H4zM10,27H11V28H10zM12,27H13V28H12zM14,27H15V28H14zM15,27H16V28H15zM17,27H18V28H17"
    "zM18,27H19V28H18zM22,27H23V28H22zM23,27H24V28H23zM24,27H25V28H24zM28,27H29V28H28zM29,27H30V28H29zM4,28H5V29H4z"
    "M6,28H7V29H6zM7,28H8V29H7zM8,28H9V29H8zM10,28H11V29H10zM14,28H15V29H14zM15,28H16V29H15zM16,28H17V29H16zM20,28H"
    "21V29H20zM21,28H22V29H21zM24,28H25V29H24zM25,28H26V29H25zM26,28H27V29H26zM27,28H28V29H27zM28,28H29V29H28zM30,2"
    "8H31V29H30zM31,28H32V29H31zM32,28H33V29H32zM4,29H5V30H4zM6,29H7V30H6zM7,29H8V30H7zM8,29H9V30H8zM10,29H11V30H10"
    "zM12,29H13V30H12zM13,29H14V30H13zM14,29H15V30H14zM18,29H19V30H18zM19,29H20V30H19zM22,29H23V30H22zM24,29H25V30H"
    "24zM27,29H28V30H27zM28,29H29V30H28zM29,29H30V30H29zM32,29H33V30H32zM4,30H5V31H4zM6,30H7V31H6zM7,30H8V31H7zM8,3"
    "0H9V31H8zM10,30H11V31H10zM12,30H13V31H12zM14,30H15V31H14zM17,30H18V31H17zM20,30H21V31H20zM25,30H26V31H25zM27,3"
    "0H28V31H27zM30,30H31V31H30zM32,30H33V31H32zM4,31H5V32H4zM10,31H11V32H10zM15,31H16V32H15zM17,31H18V32H17zM18,31"
    "H19V32H18zM19,31H20V32H19zM20,31H21V32H20zM22,31H23V32H22zM23,31H24V32H23zM24,31H25V32H24zM27,31H28V32H27zM29,"
    "31H30V32H29zM31,31H32V32H31zM4,32H5V33H4zM5,32H6V33H5zM6,32H7V33H6zM7,32H8V33H7zM8,32H9V33H8zM9,32H10V33H9zM10"
    ",32H11V33H10zM12,32H13V33H12zM13,32H14V33H13zM15,32H16V33H15zM17,32H18V33H17zM20,32H21V33H20zM22,32H23V33H22zM"
    "24,32H25V33H24zM25,32H26V33H25zM26,32H27V33H26zM29,32H30V33H29zM31,32H32V33H31z\" id=\"qr-path\" fill=\"#000000\" f"
    "ill-opacity=\"1\" fill-rule=\"nonzero\" stroke=\"none\" /></svg>"
)


def _wa_front_door_html() -> str:
    """One footer line, plus a QR on wide screens. Never a partial link."""
    num = _wa_number()
    if not num:
        return ""
    link = ('\n  <p style="margin-top:.6rem;font-size:.85rem">'
            ...
            'RelayShield bot</a></p>')
    if num != WA_QR_NUMBER:
        # Logged because this is invisible on the page by design.
        logger.warning("wa qr is stale: it encodes %s and the secret returns a "
                       "different number. Regenerate with "
                       "`python3 tools/wa_qr.py wa-devs`. Showing the link only.",
                       WA_QR_NUMBER)
        return link
    return (link +
            '\n  <div class="wa-qr">'
            '<div style="background:#fff;border-radius:10px;padding:.5rem;'
            'width:124px;color:#0d0f14">' + WA_QR_SVG + '</div>'
            '<p style="font-size:.75rem;color:var(--muted);margin:.4rem 0 0;'
            'max-width:210px">Scan to open the same chat on your phone.</p>'
            '</div>')
...
-->
<meta name="description" content="Threat intelligence and identity-compromise APIs for developers and AI agents. 494K+ indicators (7.8M+ citations) from 115 monitored Telegram marketplaces and 20 feeds. Breach, infostealer, SIM-swap, LLM credential exposure, MCP registry risk. Pay-as-you-go, no minimum.">
...
<meta property="og:description" content="494K+ indicators (7.8M+ citations) from 115 monitored Telegram marketplaces and 20 authoritative feeds. Breach, infostealer, SIM-swap, LLM credential exposure and MCP registry risk, over REST, MCP, STIX/TAXII and x402. Pay-as-you-go, no minimum.">
...
<meta name="twitter:description" content="494K+ indicators (7.8M+ citations) from 115 monitored Telegram marketplaces and 20 authoritative feeds. REST, MCP, STIX/TAXII and x402. Pay-as-you-go, no minimum.">
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* The QR is for a reader whose device cannot tap the link beside it, which
     means a desktop browser. A phone cannot scan its own screen, so below the
     breakpoint it is dead weight and the link above it is the whole feature. */
  .wa-qr { margin-top: .8rem; }
...
<div class="section">
  ...
  <div class="price-grid">
    ...
    <div class="price-card">
      ...
      <div class="desc">Asset watchlist &amp; continuous monitoring: register domains and IPs for ongoing IOC surveillance. Actions: <code>register</code> assets, <code>sweep</code> all registered assets against the 494K+ indicator corpus (7.8M+ citations), <code>list</code> or <code>remove</code>. Webhook push alerts fire automatically when new IOCs match your registered assets</div>
    </div>
    <div class="price-card">
    ...
    <div class="price-card" id="ep-scamkit-fingerprint">
      <div class="endpoint">/v1/payg/scamkit-fingerprint</div>
      <div class="price">$0.50<span class="per"> / call</span></div>
      <div class="desc">Scam-kit fingerprinting: turn one suspicious link into a matchable kit identity. Extracts the kit&apos;s structural signals (DOM skeleton, script hashes, form/exfil hosts, brand marks, URL pattern class), strips per-victim nonces and credentials before hashing, and returns a stable <code>kit_&lt;sha256&gt;</code> fingerprint ID that is identical for the same kit across sightings</div>
    </div>
    <div class="price-card" id="ep-scamkit-match">
      <div class="endpoint">/v1/payg/scamkit-match</div>
      <div class="price">$0.10<span class="per"> / call</span></div>
      <div class="desc">Scam-kit match: cheap re-check for dashboards and bots watching for kit reuse. Look up an existing <code>kit_&lt;sha256&gt;</code> fingerprint ID and get its family, confidence, verdict, evidence, and sighting history. An unknown ID is reported as no-match, never as safe</div>
    </div>
    <div class="price-card" id="ep-campaign-scan">
      <div class="endpoint">/v1/payg/campaign-scan</div>
      <div class="price">$5.50<span class="per"> flat / call</span></div>
      <div class="desc">Composite campaign scan: one flat call fans an indicator bundle (up to 25 indicators &mdash; domains, URLs, emails, wallets, phones, kit fingerprint IDs) across the threat-intel endpoints in-process, then correlates kit families, shared exfil hosts, and shared kit fingerprints across indicators into an aggregate risk score with corpus citations</div>
    </div>
  </div>
</div>
...
<div class="section" style="margin-top:2rem">
  ...
  <p style="color:var(--muted);font-size:.95rem;margin:.5rem 0 1.25rem">RelayShield&apos;s edge is OSINT threat hunting most vendors can&apos;t reach: our own collection pipeline runs continuous, verified monitoring across <strong>115 monitored Telegram marketplaces</strong> (infostealer markets, credential dumps, breach announcements), not a static feed subscription. That&apos;s layered with <strong>494K+ indicators</strong> (7.8M+ citations) aggregated from <strong>20 authoritative external sources</strong> (abuse.ch, Spamhaus, AbuseIPDB, AlienVault OTX, PhishTank, CISA KEV, MITRE ATT&amp;CK/ATLAS, and more), covering emails, domains, IPs, hashes, phone numbers, and wallet addresses.</p>
  <p style="color:var(--muted);font-size:.9rem;margin:.5rem 0 1.25rem;background:rgba(108,99,255,.07);border:1px solid rgba(108,99,255,.2);border-radius:8px;padding:.75rem 1rem"><strong style="color:var(--accent)">All 30 metered endpoints included.</strong> Both TI subscription tiers cover unlimited access to all metered API endpoints above: breach, SIM swap, infostealer, domain, OAuth &amp; token exposure, supply chain, session hijack detection, crypto asset surface, asset intel monitoring, threat actor intelligence, CVE × identity risk correlation, domain identity risk scoring, bulk IOC enrichment, IOC pivot, brand monitoring, bulk identity risk, agent framework exploit monitoring, MCP registry risk, prompt-injection breach detection, certificate expiry risk, passive DNS/IP reputation, scam-kit fingerprinting, scam-kit match, and campaign scan, in addition to the Threat Intelligence IOC and CVE feeds. No per-endpoint add-ons. One subscription, full access.</p>
...
_SOURCE_BANNERS: dict[str, tuple[tuple[str, ...], str]] = {
    ...
    "llmjacking": (
        ...
        _banner("Arriving from the LLMjacking post", _p(
            ...
            "providers against 494K+ indicators (7.8M+ citations) from 115 monitored Telegram marketplaces. A clean result means "
