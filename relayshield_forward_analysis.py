...
def quickstart_text(platform: str) -> str:
    ...
    if platform == PLATFORM_WHATSAPP:
        return (
            ...
            "*1. Forward me the message.*\n"
            "Just forward it straight here, no command needed. I read it for "
            "impersonation, urgency tactics and credential lures, and I check any "
            "link in it.\n"
            ...
            "out of it. A screenshot hides where its buttons really link, so send "
            "the link too if you have it.\n\n"
    ...
    return (
        ...
        "*1. Forward me the message.*\n"
        "Just forward it straight here, no command needed. I read it for "
        "impersonation, urgency tactics and credential lures, I check any link "
        "in it, and — because Telegram passes on who sent a forward — I check "
        "that account too, unless they have forward privacy switched on.\n\n"
        "*2. Send a screenshot.*\n"
        "Send the picture on its own, no caption needed. A screenshot hides "
        "where its buttons really link, so send the link as well if you have it.\n\n"
        "*3. Check a link before you click it.*\n"
        "`/scan <link>` — checked against our own criminal-source corpus, "
        "Google Safe Browsing and VirusTotal.\n\n"
