...
def quickstart_text(platform: str) -> str:
    ...
    if platform == PLATFORM_WHATSAPP:
        return (
            ...
            "already in your contacts. Just forward it straight here, no command "
            "needed. *A message from a name you know is exactly the case worth "
            "forwarding*: a hijacked account still shows up as your friend.\n"
    ...
    return (
        ...
        "in your contacts. Just forward it straight to @relayshield_bot, no "
        "command needed. *A message from a name you know is exactly the case "
        "worth forwarding*: a hijacked account still shows up as your friend.\n"
